...
1. `chore: create project structure`
2. `feat: add order creation endpoint`
3. `feat: add get order by id endpoint`
4. `feat: add list orders endpoint`
5. `feat: add update order endpoint`
6. `feat: add delete order endpoint`
7. `feat: add request mapping and validation`
8. `docs: add readme and examples`
